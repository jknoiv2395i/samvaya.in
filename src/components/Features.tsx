    ...
    <section id="features" className="relative w-full pt-8 sm:pt-20 pb-12 sm:pb-20 px-3 sm:px-6 max-w-[1560px] mx-auto overflow-visible">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
        ...
        <div 
          ...
          className="lg:col-span-4 rounded-3xl py-8 sm:py-12 pl-4 sm:pl-16 pr-0 relative overflow-hidden shadow-sm flex flex-col justify-center min-h-[360px] sm:min-h-[420px] lg:h-[540px]"
        >
          {/* Inner White Card - rounded on left, flush on right */}
          <div className="w-full bg-white rounded-l-xl sm:rounded-l-2xl rounded-r-none py-6 sm:py-8 px-4 sm:px-8 text-center shadow-lg flex flex-col items-center justify-center">
            {/* File Icon with Flower Illustration */}
            <div className="w-full flex items-center justify-center mb-3">
              <img
                src="/kb-file-icon.png"
                alt="Knowledge base file icon"
                className="w-28 sm:w-44 h-auto object-contain select-none pointer-events-none translate-x-1 sm:translate-x-3"
              />
            </div>

            <h4 className="font-['Inter'] font-medium text-base sm:text-[18.1px] leading-[24px] tracking-[0%] text-[#141414] text-center">
              Create your first knowledge base
            </h4>
            <p className="text-xs sm:text-[13px] text-neutral-500 mt-1 sm:-mt-0.5 mb-3 sm:mb-2.5 leading-snug whitespace-normal sm:whitespace-nowrap">
        ...
        <div 
          ...
          className="lg:col-span-6 rounded-3xl p-3 sm:p-6 lg:p-7 relative overflow-hidden shadow-sm flex flex-col items-center justify-center min-h-[460px] sm:min-h-[540px] lg:h-[540px]"
        >
          {/* Inner White Card */}
          <div className="w-full max-w-[440px] h-auto sm:h-[490px] bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-md flex flex-col justify-between items-start text-left">
            {/* Top: Header */}
            <div>
              <h4 className="text-lg sm:text-2xl md:text-[26px] font-semibold text-neutral-900 leading-tight whitespace-normal sm:whitespace-nowrap">
                Connect your phone number
              </h4>
              <p className="text-xs sm:text-[13px] text-neutral-600 mt-2 sm:mt-2.5 leading-relaxed">
